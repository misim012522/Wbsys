...
<p class="text-slate-600 mb-6">Approved staff can log in and serve the queue for their assigned office. New registrations appear under Pending accounts until you confirm them.</p>
...
<div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
    <table class="w-full">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="5" class="px-4 py-8 text-slate-500 text-center">No approved staff accounts yet. <a href="{{ route('admin.users.pending') }}" class="text-emerald-600 hover:underline">View pending accounts</a></td>
                </tr>
            @endforelse
        </tbody>
    </table>
