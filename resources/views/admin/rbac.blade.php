...
@else
    <div class="mb-6 panel p-4 md:p-6 shadow-sm">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            @if(!empty($backUrl))
                <a href="{{ $backUrl }}" class="inline-flex items-center justify-center rounded-md border border-slate-300 px-3 py-2 text-sm font-medium text-slate-700 hover:bg-white/50/30">
                    {{ $backLabel ?? 'Back' }}
                </a>
            @endif
        </div>
...
<div class="space-y-6">
        ...
        <div class="space-y-5 p-6">
            <div class="rounded-[1.5rem] border border-slate-200 bg-slate-50/70 p-5">
                ...
                <div class="mt-3 grid gap-3 md:grid-cols-3">
                    <div class="rounded-[1.75rem] border border-slate-200 bg-white/50/50 px-4 py-3">
                ...
                <div class="grid gap-5 xl:grid-cols-2">
                    <div class="overflow-hidden rounded-[1.5rem] border border-slate-200 bg-white/50/50 shadow-sm">
    ...
    <section class="space-y-5">
        ...
        <div class="panel overflow-hidden">
            ...
            <div class="space-y-4 p-6">
                ...
                <div class="rounded-[1.25rem] border border-slate-200 bg-white/50/30 p-4">
    ...
    <section class="panel p-4 md:p-6 shadow-sm">
