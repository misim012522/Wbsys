...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/rbac', [AdminRbacController::class, 'edit'])->name('rbac.edit')->middleware(['role:tenant_admin', 'permission:admin.rbac.manage']);
    Route::put('/rbac', [AdminRbacController::class, 'update'])->name('rbac.update')->middleware(['role:tenant_admin', 'permission:admin.rbac.manage']);
