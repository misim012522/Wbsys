        ...
        @forelse($staffQrCards as $card)
            <div class="panel p-6 shadow-sm">
                ...
                <div class="mt-4 text-center">
                    <div class="inline-block rounded-[1.25rem] border-2 border-slate-200 bg-white/50/50 p-3 shadow-inner">
                ...
                <div class="mt-4 flex items-center justify-between gap-2">
                    ...
                    <button
                        ...
                        class="rounded-lg border border-slate-300 bg-white/50/50 px-2.5 py-1 text-[11px] font-medium text-slate-600 hover:bg-white/50/30"
                    >
                        Copy URL
                    </button>
                </div>
                <div class="mt-1 rounded-[1.75rem] border border-slate-200 bg-white/50/30 p-3">
                ...
                <details class="mt-2">
                    ...
                    <p class="mt-2 break-all rounded-lg bg-white/50/30 p-2 font-mono text-[11px] text-slate-500">{{ $card['queue_url'] }}</p>
                </details>
                <div class="mt-4 flex flex-wrap gap-2">
                    <a href="{{ $card['queue_url'] }}" class="rounded-[1.75rem] border border-slate-300 px-4 py-2 text-sm text-slate-700 hover:bg-white/50/30">Open staff queue page</a>
                    <a href="{{ $card['qr_image_url'] }}" target="_blank" rel="noreferrer" class="rounded-[1.75rem] bg-emerald-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-emerald-700">Open QR image</a>
                </div>
            </div>
        @empty
            <div class="panel border-dashed border-slate-300 p-8 text-center text-slate-500 lg:col-span-2">
